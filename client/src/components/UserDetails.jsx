...
const UserCard = () => {
  ...
  const usagePercent = Math.min(
    Math.round((user.storage / totalBytes) * 100),
    100
  ); 
    ...
    <div className="bg-gray-50 shadow-md rounded-lg p-5 w-full">
      <div className="flex items-center gap-4 mb-4">
        <div
          ...
          className="bg-gray-900 rounded-full w-12 h-12 flex items-center justify-center text-gray-50 text-lg font-semibold"
        >
      ...
      >
        <p
          aria-label="Storage usage in bytes"
        ...
        <div
          aria-label="Legend"
          className="flex justify-start items-center mt-2 gap-4 text-gray-600"
        >
